...
// Contact-themed magical floating emojis
const floatingEmojis = [
  { emoji: "✨", left: "10%", top: "20%", animation: "float-slow", size: "text-5xl", opacity: "opacity-40" },
  { emoji: "📞", left: "85%", top: "30%", animation: "float-medium", size: "text-6xl", opacity: "opacity-30" },
  { emoji: "✉️", left: "15%", top: "60%", animation: "float-fast", size: "text-4xl", opacity: "opacity-40" },
  { emoji: "📍", left: "80%", top: "75%", animation: "float-slow", size: "text-5xl", opacity: "opacity-40" },
  { emoji: "👋", left: "20%", top: "85%", animation: "float-medium", size: "text-6xl", opacity: "opacity-30" },
];
...
const bubbles = [
  ...
  { size: 30, left: "35%", top: "25%", delay: 1, duration: 5 },
];
