...
import PlayCenterHero from "@/components/playcenter/Hero";
import PlayActivities from "@/components/playcenter/Activities";
import Safety from "@/components/playcenter/Safety";
import Equipment from "@/components/playcenter/Equipment";

// Play-themed magical floating emojis consolidated for the whole page
const floatingEmojis = [
  { emoji: "🎢", left: "5%", top: "15%", animation: "float-slow", size: "text-5xl", opacity: "opacity-30" },
  { emoji: "🌟", left: "92%", top: "25%", animation: "float-medium", size: "text-6xl", opacity: "opacity-30" },
  { emoji: "🛡️", left: "10%", top: "45%", animation: "float-fast", size: "text-4xl", opacity: "opacity-40" },
  { emoji: "🧸", left: "85%", top: "60%", animation: "float-slow", size: "text-5xl", opacity: "opacity-40" },
  { emoji: "🧩", left: "8%", top: "75%", animation: "float-medium", size: "text-5xl", opacity: "opacity-30" },
  { emoji: "🎈", left: "88%", top: "85%", animation: "float-fast", size: "text-6xl", opacity: "opacity-40" },
];
...
const bubbles = [
  ...
  { size: 55, left: "75%", top: "50%", delay: 3, duration: 7 },
  { size: 35, left: "55%", top: "15%", delay: 0.5, duration: 6 },
];
  ...
  return (
    <>
      ...
      <main className="relative min-h-screen bg-gradient-to-b from-[#FFB347] via-[#FF8C42] to-[#FF6B35] overflow-hidden flex flex-col">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-white/10 blur-[150px] rounded-full pointer-events-none z-0" />
        ...
        {/* THE COMPONENTS: Stacked cleanly over the background */}
