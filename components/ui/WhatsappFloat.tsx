...
export default function WhatsappFloat() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      {/* WhatsApp Button with Continuous Pulse */}
      <a
        href="https://wa.me/919500099749"
        target="_blank"
      ...
      >
        ...
        >
          <motion.div
            ...
            whileTap={{ scale: 0.9 }}
            className="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl relative overflow-hidden group"
          >
            {/* Inner subtle glow */}
